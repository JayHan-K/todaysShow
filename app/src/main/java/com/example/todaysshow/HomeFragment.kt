...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val personalAdapter = HomeShowAdapter(personalizedShow, context)
        val recommandedAdapter = HomeShowAdapter(recommendedShow, context)
    ...
    fun getPersonals() : ArrayList<HomeShow>{
        ...
        shows.add(HomeShow(R.drawable.show_sample1, "Show1"))
        shows.add(HomeShow(R.drawable.show_sample2, "Show2"))
        shows.add(HomeShow(R.drawable.show_sample1, "Show3"))
        shows.add(HomeShow(R.drawable.show_sample2, "Show4"))
        shows.add(HomeShow(R.drawable.show_sample1, "Show5"))
        shows.add(HomeShow(R.drawable.show_sample2, "Show6"))
        shows.add(HomeShow(R.drawable.show_sample1, "Show7"))
        shows.add(HomeShow(R.drawable.show_sample2, "Show8"))
        return shows
    }

    fun getRecommended() : ArrayList<HomeShow>{
        val shows = ArrayList<HomeShow>()
        shows.add(HomeShow(R.drawable.show_sample2, "RShow1"))
        shows.add(HomeShow(R.drawable.show_sample1, "RShow2"))
        shows.add(HomeShow(R.drawable.show_sample2, "RShow3"))
        shows.add(HomeShow(R.drawable.show_sample1, "RShow4"))
        shows.add(HomeShow(R.drawable.show_sample2, "RShow5"))
        shows.add(HomeShow(R.drawable.show_sample1, "RShow6"))
        shows.add(HomeShow(R.drawable.show_sample2, "RShow7"))
        shows.add(HomeShow(R.drawable.show_sample1, "RShow8"))
        return shows
    }
