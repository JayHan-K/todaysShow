...
class RealReviewCommentAdapter(comments: ArrayList<DetailComment>, context: Context) :
    RecyclerView.Adapter<RealReviewCommentAdapter.RealReviewCommentHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RealReviewCommentHolder {
        val inflatedView = LayoutInflater.from(parent.context).inflate(R.layout.real_review_comment_item, parent, false)
        return RealReviewCommentAdapter.RealReviewCommentHolder(inflatedView)
    }
